...
async def initialize_beanie():
    ...
    await init_beanie(database=test_db, document_models=[
        User, Booking, Doctor, DoctorApplication, Comment, Rating
    ])
    # Clear all collections before each test
    for model in [User, Booking, Doctor, DoctorApplication, Comment, Rating]:
