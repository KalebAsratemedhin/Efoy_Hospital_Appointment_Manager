    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{doctor.fullName}</h2>
          <p className="text-purple-600 font-medium mb-4">{doctor.doctorData.speciality}</p>
          
          <div className="flex items-center gap-2 text-gray-600 mb-4">
            <FaBriefcase className="text-purple-500" />
            <span>{doctor.doctorData.experience} years experience</span>
          </div>
