        ...
        <div className="flex justify-between items-center h-16">
          ...
          {pathname === '/' && <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <Link to="/services" className="text-gray-700 hover:text-cyan-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">Services</Link>
              <Link to="/contact" className="text-gray-700 hover:text-cyan-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">Contact</Link>
            </div>
          </div>}
