...
import { FaUserMd, FaCalendarAlt, FaClock, FaInfoCircle, FaArrowLeft } from "react-icons/fa";
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-6">
              ...
              <p className="text-white/80">Schedule your consultation with Dr. {doctor?.fullName}</p>
            </div>
            ...
            <div className="p-8 border-b border-gray-100">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Dr. {doctor?.fullName}</h2>
